                                ...
                                <div class="single_service d-flex justify-content-between align-items-center">
                                    <div class="service_inner d-flex align-items-center">
                                        <div class="thumb">
                                            ...
                                            <img src="{{ asset('assets/img/layanan1/'.$data->Gambar) }}" alt="{{ $data->nama_layanan1 }}" style="width:60px;height:60px">

                                        </div>
                                        <span>{{ $data->nama_layanan1 }}</span>
                                    </div>
                                    <p>Rp {{ $data->harga_layanan1 }}</p>
                                </div>
                ...
                <div class="col-xl-12">
                    ...
                    @foreach ($layanan1 as $data)
                        <div class="single_gallery">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/layanan1/'.$data->Gambar) }}" alt="{{ $data->nama_layanan1 }}">
                                <div class="image_hover">
                                    <a class="popup-image" href="{{ asset('assets/img/layanan1/'.$data->Gambar) }}">
                                        <span>{{ $data->nama_layanan1 }}</span>
                                    </a>
                                </div>
                            </div>
